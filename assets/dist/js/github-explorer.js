...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __WEBPACK_IMPORTED_MODULE_0_vue__ && __WEBPACK_IMPORTED_MODULE_0_vue__.__esModule ? function() { return __WEBPACK_IMPORTED_MODULE_0_vue__['default'] } : function() { return __WEBPACK_IMPORTED_MODULE_0_vue__; };
/* harmony import */ __webpack_require__.d(__WEBPACK_IMPORTED_MODULE_0_vue___default, 'a', __WEBPACK_IMPORTED_MODULE_0_vue___default);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api__ = __webpack_require__(2);



var api = new __WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */]();

var Explore = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.extend({
	...
	methods: {
		onSearch: function onSearch() {
			...
			this.page = 1;
			api.search(this.search, this.options.type).request(function (response) {
				this$1.results = response.total_count;
				this$1.pages = Math.ceil(this$1.results / 20);
				this$1.items = response.items;
			});
		},
		goToPage: function goToPage(page) {
			var this$1 = this;

			api.page(page).request(function (response) {
				this$1.page = page;
				this$1.items = response.items;
			});
		},
...
/* harmony default export */ exports["a"] = Explore;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Explore__ = __webpack_require__(0);


new __WEBPACK_IMPORTED_MODULE_0__components_Explore__["a" /* default */]({
	el: '#explore'
});
...
Api.prototype.search = function search(query, type) {
...
Api.prototype.page = function page(page) {
	this.currentPage = page;
	return this;
};

Api.prototype.buildSearch = function buildSearch(query, type) {
	query += ' wordpress '+ type +' in:name,description,readme language:php';
	var search = query.replace(' ', '+');
	return search;
};

Api.prototype.request = function request(callback) {
	var data = {
		q: this.searchString,
		sort: 'repositories',
		order: 'desc',
	...
	jQuery.get(this.baseUrl, data, function (response) {
...
Fragment.prototype.callHook = function (hook) {
  ...
  var i, l;
  for (i = 0, l = this$1.childFrags.length; i < l; i++) {
    this$1.childFrags[i].callHook(hook);
  }
  for (i = 0, l = this$1.children.length; i < l; i++) {
...
function stateMixin (Vue) {
  ...
  Vue.prototype._digest = function () {
    ...
    for (var i = 0, l = this$1._watchers.length; i < l; i++) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=github-explorer.js.map